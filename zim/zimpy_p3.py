""" Support for .zim file for python 3

This file is modified from zimpy.py
(https://github.com/braddockcg/internet-in-a-box/blob/master/iiab/zimpy.py)
It is modified to be a standalone file that supports reading .zim file.
While the original file doesn't work for python 3, this one is specifically modified to work for python 3.

There might still be errors in the file.
"""
...
# in python 3, use bytesIO to r/w bytes
