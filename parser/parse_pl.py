...
def parse_unordered_list_polish(ulist):
    ...
    for element in toc.children:
        if isinstance(element, Tag):
                ...
                if text[0] == '(': # only consistent thing I found across the edition for encountering translations
                    ...
                    for trans in trans_list:
                        yield (edition, page_state['headword'], page_state['headword_lang'], 
                               remove_parenthesis(trans).strip(), u'polski', 'pl', page_state['part_of_speech'])
                else:
                    page_state['translation_region'] = False
            ...
            # parse through a list to grab translations
                ...
                for translation, lang, lang_code in parse_unordered_list_polish(element):
                    yield (edition, page_state['headword'], page_state['headword_lang'], 
